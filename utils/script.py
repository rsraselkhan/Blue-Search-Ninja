...
- Send /verify in group & wait for It To Accept Or Directly Contact To Owner After Request @Rasel_BOTZ.
...
Get connected channels list with - /connections"""
    ...
    ABOUT = """Developed By @RS_Botz

✯ Mʏ Nᴀᴍᴇ:  {}
✯ Cʀᴇᴀᴛᴏʀ: <a href='https://t.me/Rasel_BOTZ'>Harman</a>
